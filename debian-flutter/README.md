...
### min
min includes the Flutter SDK and the Android SDK. Running `Flutter doctor -v` in min returns
...
```
* Doctor readout last updated: August 6th 2023

### max
max inclues the Flutter SDK, the Android SDK, and all required packages for linux and web development. Running `Flutter doctor -v` in max returns
...
Empathetech will ignore the latest tag for this image
